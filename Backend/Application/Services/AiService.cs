...
public class AiService
{
    ...
    public async Task<AiResponse?> AskAsync(AiRequest request)
    {
        ...
        var projectsNote = tr
            ? "\nCalisma alanin `generated_projects/` klasörüdür. Tüm yeni dosyalari, web sitelerini, arastirma belgelerini ve projelerini bu klasör içinde olustur."
            : "\nYour workspace is the `generated_projects/` folder. Create all new files, websites, research documents, and projects inside this folder.";
